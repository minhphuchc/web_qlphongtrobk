...
<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb-section p-0">
        <img src="<?php echo e(asset('assets/images/inner-background.jpg')); ?>" class="bg-img img-fluid" alt="">
        <div class="container">
            <div class="breadcrumb-content">
                <div>
                    <h2>Kết quả tìm kiếm: <?php echo e($search); ?></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\phongtro20\resources\views/frontend/news/filter.blade.php ENDPATH**/ ?>