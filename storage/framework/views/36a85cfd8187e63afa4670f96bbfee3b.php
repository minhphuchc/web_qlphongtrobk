                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="dropdown">
                                                <span class="dropdown-toggle font-rubik" data-bs-toggle="dropdown"><span
                                                        id="category_room"><?php echo e($category->first()->name); ?></span><i
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="dropdown">
                                                <span class="dropdown-toggle font-rubik"
                                                    data-bs-toggle="dropdown"><span><?php echo e($districts[0]->full_name); ?></span>
...
<?php $__env->startSection('js'); ?>
    ...
    <?php echo $__env->make('js.room.getMylocation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        var Path_main_image = '';
        ...
        $('#complete_3').on('click', function(ev) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    let public_route = "<?php echo e(route('xuat_ban_phong', ':id')); ?>".replace(":id", id)
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Lập Trình Web PHP NC\Project_Laravel\Web_QL_PhongTro_L10\resources\views/frontend/room/create.blade.php ENDPATH**/ ?>