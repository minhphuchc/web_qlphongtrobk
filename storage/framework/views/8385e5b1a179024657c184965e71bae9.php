<div class="page-sidebar">
    <div class="logo-wrap">
        <a href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('assets/images/logo/13.png')); ?>" class="img-fluid  for-light" alt="">
        ...
        <div class="user-profile">
            <div class="media">
                ...
                <div class="media-body">
                    <a href="user-profile.html"><h6><?php echo e(Auth::user()->name); ?></h6></a>
...
</div><?php /**PATH D:\Lập Trình Web PHP NC\Project_Laravel\Web_QL_PhongTro_L10\resources\views/layouts/components/sidebar.blade.php ENDPATH**/ ?>